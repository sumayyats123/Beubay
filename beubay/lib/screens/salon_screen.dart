...
class _SalonScreenState extends State<SalonScreen> {
  ...
  void initState() {
    ...
    // Placeholder data for salon screen
    _promotionalBanners = [
      {
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Salons Section Title and First Container - inside gradient to spread purple
                    Padding(
            ...
            children: [
              Container(
                ...
                child: service['imageUrl'] != null
                    ...
                    : const Center(
                        child: Icon(Icons.content_cut, color: Colors.grey, size: 40),
                      ),
              ),
              Positioned(
                top: 10,
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              _buildNavItem(Icons.content_cut, 'Salon', 1, null),
              _buildNavItem(Icons.spa, 'Spa', 2, const SpaScreen()),
              _buildNavItem(Icons.medical_services, 'Clinic', 3, const ClinicScreen()),
